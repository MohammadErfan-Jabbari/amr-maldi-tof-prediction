#!/usr/bin/env python3
"""
Transductive Probabilistic PCA + Self-Training for AMR Prediction.

Wrapper script that uses Factor Analysis (probabilistic PCA) for dimensionality reduction.
Handles noise explicitly and provides more robust estimates.
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Transductive Probabilistic PCA + Self-Training for AMR prediction"
    )

    # DR settings
    parser.add_argument(
        "--n-components", type=int, default=100,
        help="Number of PPCA/FA components (default: 100)"
    )
